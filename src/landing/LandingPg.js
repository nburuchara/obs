                                ...
                                <div className='meeting-submit-confirm'>
                                    ...
                                    <div className='meeting-submit-input-form-page-1'>
                                        ...
                                        <div className='meeting-submit-input-form-terms'>
                                            <textarea
                                            value={`Guideline Agreement \n\n- - - \n\nAny Bible study group or meeting may be listed in our Directory provided it adheres to the guidelines outlined below. Group submissions will be reviewed to ensure alignment with our collective mission of bringing people closer to Jesus.\n\nWe encourage groups to consider the following: \n\nInclusivity: All group members are welcome to participate in Bible studies without discrimination based on sexual orientation, gender, profession, ethnicity, or denomination.\n\nBible-focused Study: All group leaders are strongly encouraged not to stray from biblical scripture when leading the bible study portion of their meetings.   \n\nNo Endorsements: Groups should avoid endorsing any specific organizations, products, or external enterprises. \n\nAnonymity and Privacy: Groups are expected to respect the privacy of their members by avoiding public sharing of personal information, full names, or photos. \n\nRespectful Environment: All group leaders should strive to foster and maintain a respectful environment for all (recurring and new) meeting attendees. \n\nKeeping Listings Current: To maintain accurate and helpful directory listings, we rely on the active participation of group organizers and members. Here's how you can do this: (1) Review Your Listing: Check your group’s listing regularly to ensure it is up to date. (2) Contact Updates: If your group’s primary contact changes or becomes unavailable, please notify us immediately. (3) Respond Promptly: Ensure listed contacts can respond to inquiries in a timely manner, especially for those seeking their first Bible study. \n\nNewcomer Experience: Please consider the perspective of someone new to Bible studies when viewing your listing. Ensure all information is accurate and accessible. Incorrect or outdated listings can hinder someone’s ability to connect and grow in faith.
                                            `}
                                            >
